...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "fashion_collections_photos" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "payload_locked_documents_rels" (
  	...
  	"fashion_collections_id" integer
  );
  ...
  CREATE TABLE "homepage_articles" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  ALTER TABLE "fashion_collections_photos" ADD CONSTRAINT "fashion_collections_photos_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "fashion_collections_photos" ADD CONSTRAINT "fashion_collections_photos_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."fashion_collections"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "fashion_collections" ADD CONSTRAINT "fashion_collections_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "fashion_collections" ADD CONSTRAINT "fashion_collections_hero_image_id_media_id_fk" FOREIGN KEY ("hero_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "homepage_gallery" ADD CONSTRAINT "homepage_gallery_collection_id_fashion_collections_id_fk" FOREIGN KEY ("collection_id") REFERENCES "public"."fashion_collections"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "homepage_articles" ADD CONSTRAINT "homepage_articles_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."homepage"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "about" ADD CONSTRAINT "about_cv_id_documents_id_fk" FOREIGN KEY ("cv_id") REFERENCES "public"."documents"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "fashion_collections_photos_order_idx" ON "fashion_collections_photos" USING btree ("_order");
  CREATE INDEX "fashion_collections_photos_parent_id_idx" ON "fashion_collections_photos" USING btree ("_parent_id");
  CREATE INDEX "fashion_collections_photos_image_idx" ON "fashion_collections_photos" USING btree ("image_id");
  CREATE UNIQUE INDEX "fashion_collections_slug_idx" ON "fashion_collections" USING btree ("slug");
  CREATE INDEX "fashion_collections_image_idx" ON "fashion_collections" USING btree ("image_id");
  CREATE INDEX "fashion_collections_hero_image_idx" ON "fashion_collections" USING btree ("hero_image_id");
  ...
  CREATE INDEX "homepage_gallery_collection_idx" ON "homepage_gallery" USING btree ("collection_id");
  CREATE INDEX "homepage_articles_order_idx" ON "homepage_articles" USING btree ("_order");
  CREATE INDEX "homepage_articles_parent_id_idx" ON "homepage_articles" USING btree ("_parent_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "fashion_collections_photos" CASCADE;
  ...
  DROP TABLE "homepage_articles" CASCADE;
